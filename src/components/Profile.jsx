...
function Profile({ onLogout, numberOfPeople = 1 }) {
  return (
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800">{numberOfPeople} {numberOfPeople === 1 ? 'user' : 'users'}</p>
                <p className="text-xs text-gray-500 mt-1">Expenses split automatically</p>
              </div>
            </div>
          </div>
        </div>
